...
impl Procedure {
    ...
    /// Returns whether this procedure is `Procedure::Accumulate { .. }`.
    #[inline]
    pub fn is_accumulate(self) -> bool {
        if let Procedure::Accumulate { .. } = self { true } else { false }
    }
}
...
impl Animate for i32 {
    ...
    fn animate(&self, other: &Self, procedure: Procedure) -> Result<Self, ()> {
        ...
        Ok((*self as f64 * self_weight + *other as f64 * other_weight).round() as i32)
    }
}
...
impl Animate for f32 {
    ...
    fn animate(&self, other: &Self, procedure: Procedure) -> Result<Self, ()> {
        let (self_weight, other_weight) = procedure.weights();
        Ok((*self as f64 * self_weight + *other as f64 * other_weight).round() as f32)
    }
}
...
impl Animate for f64 {
    ...
    fn animate(&self, other: &Self, procedure: Procedure) -> Result<Self, ()> {
        let (self_weight, other_weight) = procedure.weights();
        Ok(*self as f64 * self_weight + *other as f64 * other_weight)
    }
}
